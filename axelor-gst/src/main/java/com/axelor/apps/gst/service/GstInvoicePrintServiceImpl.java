...
//		if(Beans.get(AppGstRepository.class).all().filter("self.code =?","gst").fetchOne()!=null) {
...
//		        ReportFactory.createReport("Invoice.rptdesign", title + " - ${date}");
//
